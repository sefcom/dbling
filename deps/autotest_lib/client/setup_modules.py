...
from autotest_lib.client.common_lib import check_version
# sys.path.pop(0)
...
def _monkeypatch_logging_handle_error():
    ...
    assert isinstance(logging.Handler.handleError, collections.Callable)
