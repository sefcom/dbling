...
latex_documents = [
    (master_doc, 'dbling.tex', 'dbling Documentation',
     'Mike Mabey', 'manual'),
]
...
man_pages = [
    (master_doc, 'dbling', 'dbling Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dbling', 'dbling Documentation',
     author, 'dbling', 'One line description of project.',
     'Miscellaneous'),
]
